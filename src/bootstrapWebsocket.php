...
$app['autoloader']->registerNamespace('Monolog', __DIR__ . '/../vendor/monolog/monolog/src');
...
$app['autoloader']->registerNamespace('Symfony\\Component\\Yaml', __DIR__ . '/../vendor/symfony/yaml');
$app['autoloader']->registerNamespace('PhpAmqpLib', __DIR__ . '/../vendor/videlalvaro/php-amqplib');
